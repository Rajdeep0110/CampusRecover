...
The project aims to provide students with a simple and organized platform to report lost belongings, report found items, upload item images, search for belongings, and improve the overall Lost & Found experience on campus.
...
The project was developed by identifying the limitations and student-experience gaps that can exist in a traditional institution-managed Lost & Found process and exploring how a dedicated student-focused web application could address them.
...
Provide students with an easy way to report lost belongings.
Allow students to report belongings they have found.
Allow users to upload images of reported items.
Provide detailed information about item locations.
Provide search and filtering functionality.
Provide secure user authentication.
Reduce dependency on informal communication channels.
Create a centralized digital Lost & Found experience.
Improve the process of identifying and recovering belongings.
Explore how technology can solve a practical campus problem.
✨ Key Features
🔐 User Authentication
